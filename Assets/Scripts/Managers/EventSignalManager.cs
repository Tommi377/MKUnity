...
public static class EventSignalManager {
    ...
    public static void ChangeHandUIMode(object sender, HandUI.Modes mode) => OnChangeHandUIMode?.Invoke(sender, new OnChangeHandUIModeArgs() { mode = mode });
